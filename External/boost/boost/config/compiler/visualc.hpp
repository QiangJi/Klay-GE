...
// we have ThreadEx or GetSystemTimeAsFileTime unless we're running WindowsCE or WinRT
#if !defined(_WIN32_WCE) && !defined(UNDER_CE) && !(defined(WINAPI_FAMILY) && (WINAPI_FAMILY == WINAPI_FAMILY_APP))
